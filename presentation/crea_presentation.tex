...
%\logo{\includegraphics[width=30px]{logo.png}}
...
\begin{tabular}{c c}
\includegraphics[width=0.30\linewidth]{starfall.png}&
\includegraphics[width=0.30\linewidth]{rink.jpg} \\
\includegraphics[angle=270, origin=c, width=0.30\linewidth]{alfie.jpg}&
\includegraphics[angle=270, origin=c, width=0.30\linewidth]{camping.jpg}\\
\end{tabular}
...
\includegraphics[width=1.0\linewidth]{campus.jpg}
\end{column}
\end{columns}
...
\centering
\begin{tabular}{c c}
\includegraphics[width=0.40\linewidth]{malto_webcam.png} &
\includegraphics[width=0.40\linewidth]{bitshift_webcam.png}\\
\includegraphics[width=0.40\linewidth]{csc.png} &
\includegraphics[width=0.40\linewidth]{steve_garan.jpg}\\
\end{tabular}
